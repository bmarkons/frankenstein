...
class AccommodationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accommodation" do
    assert_difference('Accommodation.count') do
      post accommodations_url, params: { accommodation: { address: @accommodation.address, approved: @accommodation.approved, average_grade: @accommodation.average_grade, description: @accommodation.description, image_url: @accommodation.image_url, latitude: @accommodation.latitude, longitude: @accommodation.longitude, name: @accommodation.name, place_id: @accommodation.place_id } }
    end
  ...
  test "should update accommodation" do
    patch accommodation_url(@accommodation), params: { accommodation: { address: @accommodation.address, approved: @accommodation.approved, average_grade: @accommodation.average_grade, description: @accommodation.description, image_url: @accommodation.image_url, latitude: @accommodation.latitude, longitude: @accommodation.longitude, name: @accommodation.name, place_id: @accommodation.place_id } }
