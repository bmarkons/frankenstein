...
class Admin::AccommodationTypesControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create accommodation_type" do
    assert_difference('Admin::AccommodationType.count') do
      post accommodation_types_url, params: { accommodation_type: {  } }
    end

    assert_redirected_to accommodation_type_url(Admin::AccommodationType.last)
  end
  ...
  test "should update accommodation_type" do
    patch accommodation_type_url(@accommodation_type), params: { accommodation_type: {  } }
    assert_redirected_to accommodation_type_url(@accommodation_type)
  end

  test "should destroy accommodation_type" do
    assert_difference('Admin::AccommodationType.count', -1) do
